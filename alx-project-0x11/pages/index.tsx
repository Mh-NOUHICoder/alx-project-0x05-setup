    ...
    <div className="flex flex-col items-center min-h-screen bg-gray-200 p-4">
      <div className="flex flex-col items-center">
        ...
        <p className="text-lg text-gray-700 mb-4">
          Go on, make something amazing!
        </p>
        <p className="text-lg text-gray-700 mb-4">
          Need prompt ideas? Get your boost from the masterminds at
          <a className="text-blue-500 underline hover:text-blue-600 ml-1 font-medium" href="https://www.bananaprompts.xyz/" target="_blanc">Banana Prompts</a>. 😉
        </p>
